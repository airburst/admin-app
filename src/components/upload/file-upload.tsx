...
export function FileUpload() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-col gap-y-6">
      <Card
        className="group flex max-h-50 w-full cursor-pointer flex-col items-center justify-center gap-4 border-dashed py-8 text-sm transition-colors hover:bg-muted/50"
